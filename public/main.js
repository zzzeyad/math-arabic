 function submitQuiz() {
    ...
    function submitQuizm() {
     ...
     function submitQuizm2() {
        ...
        if(selectedValue === "correct"){
            score++;
            resultDiv.innerText ="الاجابة صحيحة لان 12÷2×10=60سم";
            resultDiv.style.color= "green";
        }
        else{
        resultDiv.innerText ="الاجابة خاطئة الاجابة الصحيحة هي:60سم ";
            resultDiv.style.color= "red";

        }
        if(selectedValue2 === "correct"){
            score++;
             resultDiv2.innerText =" الاجابة صحيحة لان 7×4=28سم";
             resultDiv2.style.color ="green";
        }
        else{
             resultDiv2.innerText ="الاجابة خاطئة الاجابة الصحيحة هي:28سم";
             resultDiv2.style.color ="red";
    ...
    function submitQuizm3() {
        ...
        resultDiv.innerText ="الاجابة خاطئة الاجابة الصحيحة هي:(3,2.5) ";
            resultDiv.style.color= "red";
        ...
        if(selectedValue2 === "correct"){
            score++;
             ...
             resultDiv2.innerText ="الاجابة خاطئة الاجابة الصحيحة هي:الانسحاب";
             resultDiv2.style.color ="red";
...
resultDiv.innerText ="الاجابة خاطئة الاجابة الصحيحة:المفعول لاجله";
resultDiv.style.color ="red";
}
if(selectedValue2 === "correct" ){
    score++;
...
resultDiv2.innerText ="الاجابة خاطئة الاجابة الصحيحة:منصوبة";
resultDiv2.style.color ="red";
}
resultDivs.innerText =`لقد حصلت على ${score} من 2`;
resultDivs.style.color ="red";
